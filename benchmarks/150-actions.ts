...
export const actions = {
  ...
  c1: createStandardAction('c1')<string>(),
  c2: createStandardAction('c2')<string>(),
  c3: createStandardAction('c3')<string>(),
  c4: createStandardAction('c4')<string>(),
  c5: createStandardAction('c5')<string>(),
  c6: createStandardAction('c6')<string>(),
  c7: createStandardAction('c7')<string>(),
  c8: createStandardAction('c8')<string>(),
  c9: createStandardAction('c9')<string>(),
  c10: createStandardAction('c10')<string>(),
  c11: createStandardAction('c11')<string>(),
  c12: createStandardAction('c12')<string>(),
  c13: createStandardAction('c13')<string>(),
  c14: createStandardAction('c14')<string>(),
  c15: createStandardAction('c15')<string>(),
  c16: createStandardAction('c16')<string>(),
  c17: createStandardAction('c17')<string>(),
  c18: createStandardAction('c18')<string>(),
  c19: createStandardAction('c19')<string>(),
  c20: createStandardAction('c20')<string>(),
  c21: createStandardAction('c21')<string>(),
  c22: createStandardAction('c22')<string>(),
  c23: createStandardAction('c23')<string>(),
  c24: createStandardAction('c24')<string>(),
  c25: createStandardAction('c25')<string>(),
  c26: createStandardAction('c26')<string, number>(),
  c27: createStandardAction('c27')<string, number>(),
  c28: createStandardAction('c28')<string, number>(),
  c29: createStandardAction('c29')<string, number>(),
  c30: createStandardAction('c30')<string, number>(),
  c31: createStandardAction('c31')<string, number>(),
  c32: createStandardAction('c32')<string, number>(),
  c33: createStandardAction('c33')<string, number>(),
  c34: createStandardAction('c34')<string, number>(),
  c35: createStandardAction('c35')<string, number>(),
  c36: createStandardAction('c36')<string, number>(),
  c37: createStandardAction('c37')<string, number>(),
  c38: createStandardAction('c38')<string, number>(),
  c39: createStandardAction('c39')<string, number>(),
  c40: createStandardAction('c40')<string, number>(),
  c41: createStandardAction('c41')<string, number>(),
  c42: createStandardAction('c42')<string, number>(),
  c43: createStandardAction('c43')<string, number>(),
  c44: createStandardAction('c44')<string, number>(),
  c45: createStandardAction('c45')<string, number>(),
  c46: createStandardAction('c46')<string, number>(),
  c47: createStandardAction('c47')<string, number>(),
  c48: createStandardAction('c48')<string, number>(),
  c49: createStandardAction('c49')<string, number>(),
  c50: createStandardAction('c50')<string, number>(),
};
