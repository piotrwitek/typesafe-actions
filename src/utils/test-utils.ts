...
export namespace types {
  ...
  export const WITH_ERROR = 'WITH_ERROR';
  export const WITH_PAYLOAD_ERROR = 'WITH_PAYLOAD_ERROR';
  export const WITH_META_ERROR = 'WITH_META_ERROR';
  export const WITH_PAYLOAD_META_ERROR = 'WITH_PAYLOAD_META_ERROR';
