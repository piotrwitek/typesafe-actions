...
describe('createAsyncAction', () => {
  it('should create an async action with types', () => {
    ...
    // @dts-jest:pass:snap -> T.EmptyAction<"FETCH_TODOS_REQUEST">
    requestResult;
    ...
    // @dts-jest:pass:snap -> T.PayloadAction<"FETCH_TODOS_SUCCESS", Todo[]>
    successResult;
    ...
    // @dts-jest:pass:snap -> T.PayloadAction<"FETCH_TODOS_FAILURE", Error>
    failureResult;
