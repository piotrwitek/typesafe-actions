...
// @dts-jest:group with optional meta
{
...
// @dts-jest:group with optional payload and meta
{
...
// @dts-jest:group with payload and optional meta
{
...
// @dts-jest:group with optional payload and optional meta
{
...
// @dts-jest:group with optional error
{
...
// @dts-jest:group with payload, meta, and error
{
...
// @dts-jest:group with payload, meta, and optional error
{
...
// @dts-jest:group with optional payload, optional meta, and optional error
{
