...
export type AsyncActionBuilderCreator<
  ...
  P3
> = {
  request: ActionBuilderCreator<T1, Box<P1>>;
  success: ActionBuilderCreator<T2, Box<P2>>;
  failure: ActionBuilderCreator<T3, Box<P3>>;
};
